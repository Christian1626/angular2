...
var HeroService = (function () {
    ...
    HeroService.prototype.post = function (hero) {
        ...
        return this.http.post(this.heroesUrl, JSON.stringify(hero), { headers: headers }).toPromise().then(function (response) { return response.json().data; }).catch(this.handleError);
    };
